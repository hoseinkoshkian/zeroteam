...
export default function Footer() {
  return (
    <footer className="pt-10 lg:pt-20 border-t border-z-border mt-10">
        ...
        >
          <div id="footer-des" className="flex flex-col gap-5 lg:w-1/2 ">
            ...
            >
              ...
              شاید بهترین تعریف در کوتاه ترین جمله از مجموعه برنامه نویسی
              زیروتیم همین باشه اما پشت این جمله هزاران طلای خاک شده وجود داره
              که نیاز به همراهی شما داره تا به خلق یک سیستم نوظهور پرطرفدار برسه
              💙
            </h6>
          </div>
