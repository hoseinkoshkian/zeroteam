  ...
  return (
    <main className="flex flex-col gap-20">
      ...
      <section className="" id="cooperation-path">
        ...
        <OrderItem text="در اولین قدم، جلسه‌ای برای آشنایی با شما و درک دقیق نیازها و اهداف پروژه برگزار می‌کنیم. در این مرحله، ما به نیازهای شما گوش می‌دهیم و سوالات لازم را مطرح می‌کنیم تا به تمام جزئیات پروژه آگاه شویم." title="شناخت نیاز ها" intent={"reqs"} number={2} dir={false} />
        <OrderItem text="در اولین قدم، جلسه‌ای برای آشنایی با شما و درک دقیق نیازها و اهداف پروژه برگزار می‌کنیم. در این مرحله، ما به نیازهای شما گوش می‌دهیم و سوالات لازم را مطرح می‌کنیم تا به تمام جزئیات پروژه آگاه شویم." title="شناخت نیاز ها" intent={"reqs"} number={3} dir={true} />
      </section>
    </main>
  );
}
